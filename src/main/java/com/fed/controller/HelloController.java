...
public class HelloController {
	...
	public String HelloWorld(Model model){
	  ...
	  //视图渲染，/WEB-INF/view/HelloWorld.jsp
		return "index";  //页面的名称，根据此字符串会去寻找名为HelloWorld.jsp的页面
	}

	@RequestMapping(value="/display",method=RequestMethod.GET)
	public String helloDisplay(Model model){

		model.addAttribute("message","Hello Spring MVC!!!");  //传参数给前端

		//视图渲染，/WEB-INF/view/HelloWorld.jsp
		return "display";  //页面的名称，根据此字符串会去寻找名为HelloWorld.jsp的页面
	}
}